export default {
  header: {
    ...
    phoneTitle: 'Are you sure you want to change the phone number?',
    phoneContent: 'Click "Confirm" or press Enter to make the changes.',
    phoneError: 'Please enter the correct phone number',
    phoneSuccess: 'Binding successful',
    phoneHover:
      'It only serves as a user identification function and does not collect any user information',
  },
  common: {
    type: 'en',
    ...
    rerankScoreThresholdLabel: 'Rerank Score Threshold',
    rerankScoreThresholdLabelDescription:
      'When performing relevance enhancement, any relevance below this threshold is discarded.',
  ...
  bots: {
    ...
    bindKbtoPreview:
      'Once the associated knowledge base is added, you can preview and debug',
    ...
    charLimit: 'The character limit has been exceeded',
    roleSetPlaceholder: `- You are a patient, friendly, and professional robot that can answer users' various questions.
- Based on the search results in the knowledge base, answer questions clearly and concisely.
- Do not fabricate answers. If the answer is not found in verified sources or cannot be derived from verified sources, respond with "I'm sorry, I cannot answer your question." 
(Or you can modify it to: If the given search results do not provide an answer, try to answer the user's question to the best of your knowledge using your knowledge.)`,
    welcomeMsgPlaceholder:
      'Hello, I am your personal robot. Is there anything I can assist you with?',
  },
  progress: {
