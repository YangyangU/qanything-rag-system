          ...
          <ul id="chat-ul" ref="scrollDom">
            <li class="ai">
              ...
              <div class="ai-content">
                <div class="ai-right">
                  <p
                    class="question-text welcome"
                    v-html="
                      botInfo.welcome_message || bots.welcomeMsgPlaceholder
                    "
                  ></p>
                </div>
              </div>
                ...
                <div class="ai-content">
                  <div class="ai-right">
                    ...
                    >
                      ...
                      <ChatInfoPanel
                        v-if="
                          Object.keys(item?.itemInfo?.tokenInfo || {}).length
                        "
...
onMounted(() => {
  ...
  chatSettingFormActive.value = {
    ...
    rerankScoreThreshold: chatSetting.rerankScoreThreshold,
    capabilities: {
