      ...
      <div class="edit-qa-set-comp">
        <div class="tabs">
          <div
            :class="[
              'tab-item',
              tabIndex === item.value ? 'tab-item-active' : '',
            ]"
        ...
        >
          <a-form-item
            name="question"
            :rules="[{ required: true, message: home.plsInputQ }]"
          >
            <a-input
          ...
          <a-form-item
            name="answer"
            :rules="[{ required: true, message: home.plsInputA }]"
          >
            <a-textarea
          ...
          <div class="box">
            ...
            <div
              ...
              :class="[
                'upload-box',
                'upload-list',
                `upload-${uploadFileList[0].status}`,
              ]"
            >
              <UploadList>
                <template #default>
    ...
    .then((data) => {
      ...
      if (data.code === 200) {
        ...
        list.forEach((item) => {
          ...
          uploadFileList.value[item.order].errorText =
            data?.msg || common.upFailed;
        });
      }
    })
    .catch((error) => {
